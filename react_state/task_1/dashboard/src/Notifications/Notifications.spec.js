...
describe('Notifications Component', () => {
  ...
  test("calls handleDisplayDrawer when menu item is clicked", () => {
    ...
    render(<Notifications handleDisplayDrawer={handleDisplayDrawer} displayDrawer={false} />);
  ...
  test("calls handleHideDrawer when close button is clicked", () => {
    ...
    render(<Notifications handleHideDrawer={handleHideDrawer} displayDrawer={true} />);
